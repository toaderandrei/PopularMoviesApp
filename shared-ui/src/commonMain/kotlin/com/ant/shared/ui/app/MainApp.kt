...
import com.ant.ui.components.navigation.PopularMoviesTopAppBar
import com.ant.ui.components.scaffold.PopularMoviesNavigationSuiteScaffold
import com.ant.ui.components.scaffold.isTopLevelDestinationInHierarchy
import com.ant.ui.components.background.PopularMoviesBackground
import com.ant.ui.components.background.PopularMoviesGradientBackground
import com.ant.ui.components.background.GradientColors
import com.ant.ui.navigation.state.MainContentState
import com.ant.ui.navigation.state.rememberMainContentState
...
import com.ant.resources.checking_authentication_state
import org.jetbrains.compose.resources.stringResource

@Composable
expect fun provideMainActivityViewModel(): MainActivityViewModel

@Composable
fun MainApp(
    navController: NavHostController = rememberNavController(),
    mainActivityViewModel: MainActivityViewModel = provideMainActivityViewModel()
) {
    val snackbarHostState = remember { SnackbarHostState() }
    val authenticationState by mainActivityViewModel.isUserLoggedIn.collectAsStateWithLifecycle()
    var isLoading by remember { mutableStateOf(true) }
    val authenticationStateTitle = stringResource(Res.string.checking_authentication_state)
