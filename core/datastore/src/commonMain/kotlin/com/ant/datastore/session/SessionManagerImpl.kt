 ...
 *
 * Persists session credentials (session ID, username) and guest-mode preference,
 * and exposes reactive authentication status via [kotlinx.coroutines.flow.StateFlow].
 *
 * @param dataStore The Preferences DataStore used for persistence.
 * @param scope Coroutine scope used for [stateIn] sharing of authentication flows.
 */
