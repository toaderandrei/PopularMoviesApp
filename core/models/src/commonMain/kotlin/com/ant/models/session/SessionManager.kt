...
/**
 * Manages user authentication sessions, including login state, session persistence,
 * and guest mode.
 */
interface SessionManager {
    ...
    /**
     * Saves the username to the data store.
    ...
    /**
     * Observes whether the app is currently in guest mode.
     */
