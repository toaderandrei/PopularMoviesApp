...
/**
 * Represents the outcome of an asynchronous operation: [Loading], [Success], or [Error].
 */
...
/**
 * Transforms this [Result] by applying the appropriate callback based on its state.
 *
 * @return the value produced by [onSuccess], [onLoading], or [onFailure].
 */
...
/**
 * Returns the [Throwable] if this is a [Result.Error], or null otherwise.
 */
