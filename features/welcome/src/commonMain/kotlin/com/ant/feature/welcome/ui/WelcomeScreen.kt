...
import com.ant.resources.continue_as_guest
import com.ant.resources.login_with_tmdb
import com.ant.resources.movie_image_desc
import com.ant.resources.welcome_subtitle
import com.ant.resources.welcome_title
    ...
    Box(
        ...
        if (uiState.backdropUrl != null) {
            AsyncImage(
                ...
                contentDescription = stringResource(Res.string.movie_image_desc),
            ...
            uiState.isLoading -> {
                ...
                Column(
                    ...
                    Button(
                        ...
                        Text(stringResource(Res.string.login_with_tmdb))
                    }
